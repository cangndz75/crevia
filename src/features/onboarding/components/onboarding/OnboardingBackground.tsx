...
export function OnboardingBackground() {
  return (
    <View style={StyleSheet.absoluteFill} pointerEvents="none">
      <LinearGradient
        colors={[onboardingTokens.background, onboardingTokens.backgroundGradientEnd, '#FBF8FF']}
        locations={[0, 0.55, 1]}
      ...
      <Svg style={styles.skyline} width="100%" height={220} viewBox="0 0 390 220" preserveAspectRatio="xMidYMax meet">
        ...
        <Rect x={200} y={108} width={52} height={86} rx={10} fill={onboardingTokens.green} opacity={0.1} />
