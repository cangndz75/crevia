...
export const PROFILE_UI_COPY = {
  ...
  profileSummaryTitle: 'PROFİL ÖZETİ',
  authorityTitle: 'YETKİ DURUMU',
  officialDuty: 'Resmi Görev',
  authorityTrust: 'YETKİ GÜVENİ',
  remainingTrust: 'KALAN GÜVEN',
  nextEvaluation: 'Sonraki değerlendirme',
  upperManagementEvaluation: 'Üst Yönetim Değerlendirmesi',
  strengthsTitle: 'GÜÇLÜ YÖNLERİN',
  roleAdvantagesTitle: 'ROL AVANTAJLARIN',
  roadmapTitle: 'YOL HARİTAN',
  seeDetails: 'Detayları gör',
  seeAll: 'Tümünü gör',
  fullRoadmap: 'Tüm yol haritası',
