...
type OperationalEventsListScreenProps = {
  /** Üst kabuk dışarıdan verildiğinde (ör. ana operasyon önizlemesi). */
  embedded?: boolean;
};

/** Pilot sonrası / ana operasyon modu — önceki olay listesi deneyimi. */
export function OperationalEventsListScreen({
  embedded = false,
}: OperationalEventsListScreenProps) {
  ...
  const listBody = (
    <ScrollView
      ...
      <View style={styles.intro}>
        ...
        <Text style={styles.subtitle}>Şehirde bekleyen kararları yönet.</Text>
  ...
  if (embedded) {
    return <View style={styles.root}>{listBody}</View>;
  }
